        ...
        <div class="same-height-row">
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Rating</h3>
                    <p>Berikan rating pada makanan yang kamu sukai</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Spesial untuk Poljan</h3>
                    <p>Aplikasi ini di khususkan untuk informasi delivery makanan di kawasan Politeknik Pajajaran.</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <p>Aplikasi ini memberikan informasi mengenai menu makanan di warung-warung area Politeknik Pajajaran</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase">Sajiwa bekerja sama dengan beberapa warung.</h3>
