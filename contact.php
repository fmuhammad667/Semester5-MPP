...
<head>
    ...
    <link rel="shortcut icon" href="sajiwa-logo.png">
...
<body>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    <img src="sajiwa-logo.png" class="hidden-xs" width="50px">
                </a>
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href="cart.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span
                            class="hidden-sm">Keranjang Belanja</span></a>
                </div>
                <?php        
                    }
                    else{
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href="cart.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span
                            class="hidden-sm">Keranjang Belanja (<?php echo $item;?>)</span></a>
                </div>
                <?php
                    }
                ?>
                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <p>Politeknik Pajajaran
                                    <br>Jalan PPHH Mustopa No. 39
                                    <br>Cibeunying Kidul
                                    <br>Kota Bandung
                                    <br>
                            ...
                            <div class="col-sm-4">
                                ...
                                <p><strong>+628511111</strong>
                                </p>
                            </div>
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                                <h3><i class="fa fa-envelope"></i> Email</h3>
                                <p class="text-muted">Gunakan email untuk saran dan keluhan.</p>
                                <ul>
                                    <li><strong><a href="mailto:">kelompok5@poljan.ac.id</a></strong>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-sm-4 -->
                        ...
                        <hr>
                            ...
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.909729190234!2d107.64987697379046!3d-6.9013985675367575!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e793e9c3007f%3A0x35fe8df2dde2c8c5!2sPoliteknik%20Pajajaran!5e0!3m2!1sid!2sid!4v1705967355137!5m2!1sid!2sid"
 ...
 _________________________________________________________ -->
        <div id="copyright">
            <div class="container">
                <div class="col-md-6">
                    <p class="pull-left">© Sajiwa 2024</p>
                </div>
                <div class="col-md-6">
